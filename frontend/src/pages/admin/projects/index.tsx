    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2">
          <Link href={`/admin/projects/edit/${row.id}`} aria-label="Modifier" className="p-1.5 rounded-lg hover:bg-white/10 text-white/50 hover:text-white transition-colors">
            <Edit size={14} />
          </Link>
