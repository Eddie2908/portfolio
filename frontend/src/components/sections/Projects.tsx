...
const ProjectCard = forwardRef<HTMLDivElement, any>(function ProjectCard({ project, i, onOpen }, ref) {
  const handleMove = (e) => {
      ...
      >
        {project.image_url ? (
          <Image
            ...
            className="object-cover opacity-95 group-hover:scale-110 group-hover:opacity-100 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]"
          />
        ) : (
